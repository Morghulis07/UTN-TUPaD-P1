...
#El programa solo muesta un mensaje si la edad es mayor a 18, no hace nada si es menor o igual a 18.

'''Ejercicio 2: Escribir un programa que solicite su nota al usuario. Si la nota es mayor o igual a 6, deberá mostrar por pantalla un mensaje que diga “Aprobado”; en caso contrario deberá mostrar el 
mensaje “Desaprobado”.'''
...
'''Ejercicio 3: Escribir un programa que permita ingresar solo números pares. Si el usuario ingresa un número par, imprimir por en pantalla el mensaje "Ha ingresado un número par"; en caso contrario, imprimir por
 pantalla "Por favor, ingrese un número par". Nota: investigar el uso del operador de módulo (%) en Python para evaluar si un número es par o impar.'''
...
'''Escribir un programa que permita introducir contraseñas de entre 8 y 14 caracteres (incluyendo 8 y 14). Si el usuario ingresa una contraseña de longitud adecuada, imprimir por en pantalla el mensaje "Ha ingresado
 una contraseña correcta"; en caso contrario, imprimir por pantalla "Por favor, ingrese una contraseña de entre 8 y 14 caracteres". Nota: investigue el uso de la función len() en Python para evaluar la cantidad de 
...
Teniendo en cuenta lo antes mencionado, escribir un programa que tome la lista numeros_aleatorios, calcule su moda, su mediana y su media y las compare para determinar si hay sesgo positivo, negativo o no hay sesgo.
...
''' Escribir un programa que solicite una frase o palabra al usuario. Si el string ingresado termina con vocal, añadir un signo de exclamación al final e imprimir el string resultante por pantalla; en caso contrario,
...
print("Ingresa la magnitud del terremoto (escala de Richter):")
...
print("¿En qué hemisferio te encuentras? (N/S):")
hemisferio = input().upper()

print("¿Qué mes es? (1 a 12):")
mes = int(input())

print("¿Qué día es? (1 a 31):")
dia = int(input())
...
if hemisferio == "N":
    ...
    print("Estás en el hemisferio norte. Estación actual:", estacion)
elif hemisferio == "S":
    estacion = estacion_sur(mes, dia)
    print("Estás en el hemisferio sur. Estación actual:", estacion)
else:
